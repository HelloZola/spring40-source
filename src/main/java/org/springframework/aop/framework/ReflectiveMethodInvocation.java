...
public class ReflectiveMethodInvocation implements ProxyMethodInvocation, Cloneable {
    ...
    public Object proceed() throws Throwable {
        ...
        int curInterceptor = this.currentInterceptorIndex;

        PrintContolUtils.print(PrintContolUtils.Aop, "classname:" + classname + " curInterceptor:" + curInterceptor);

        Object interceptorOrInterceptionAdvice =
                this.interceptorsAndDynamicMethodMatchers.get(++this.currentInterceptorIndex);
        PrintContolUtils.print(PrintContolUtils.Aop, "获取之后classname:" + interceptorOrInterceptionAdvice.getClass().getSimpleName() + " curInterceptor:" + curInterceptor);
